	...
	value _v_f)
{
  ...
  _res = camlidl_z3_Z3_fixedpoint_get_rules(c, f);
  _vres = camlidl_c2ml_z3_Z3_ast_vector(&_res, _ctx);
  camlidl_free(_ctx);
  /* begin user-supplied deallocation sequence */
check_error_code(c);
	...
	value _v_f)
{
  ...
  camlidl_ml2c_z3_Z3_context(_v_c, &c, _ctx);
  camlidl_ml2c_z3_Z3_fixedpoint(_v_f, &f, _ctx);
  _res = camlidl_z3_Z3_fixedpoint_get_assertions(c, f);
  _vres = camlidl_c2ml_z3_Z3_ast_vector(&_res, _ctx);
  camlidl_free(_ctx);
  /* begin user-supplied deallocation sequence */
check_error_code(c);
	...
	value _v_s)
{
  ...
  camlidl_ml2c_z3_Z3_fixedpoint(_v_f, &f, _ctx);
  camlidl_ml2c_z3_Z3_string(_v_s, &s, _ctx);
  _res = camlidl_z3_Z3_fixedpoint_from_string(c, f, s);
  _vres = camlidl_c2ml_z3_Z3_ast_vector(&_res, _ctx);
  camlidl_free(_ctx);
  /* begin user-supplied deallocation sequence */
check_error_code(c);
	...
	value _v_s)
{
  ...
  camlidl_ml2c_z3_Z3_fixedpoint(_v_f, &f, _ctx);
  camlidl_ml2c_z3_Z3_string(_v_s, &s, _ctx);
  _res = camlidl_z3_Z3_fixedpoint_from_file(c, f, s);
  _vres = camlidl_c2ml_z3_Z3_ast_vector(&_res, _ctx);
  camlidl_free(_ctx);
  /* begin user-supplied deallocation sequence */
check_error_code(c);
	...
	value _v_param_value)
{
  ...
  camlidl_z3V3_Z3_global_param_set(param_id, param_value);
  camlidl_free(_ctx);
  return Val_unit;
}
	...
	value _v_param_id)
{
  ...
  camlidl_ml2c_z3V3_Z3_string(_v_param_id, &param_id, _ctx);
  param_value = &_c1;
  param_value = camlidl_z3V3_Z3_global_param_get(param_id);
  if (param_value == NULL) {
    _vres = Val_int(0);
  } else {
