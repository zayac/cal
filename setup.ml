...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4fd2f027ba67623677180d04c12cf9f3) *)
(*
...
let setup_t =
  {
     ...
     doc = [("cal-api", OCamlbuildDocPlugin.doc_build "src")];
     ...
     clean_doc = [("cal-api", OCamlbuildDocPlugin.doc_clean "src")];
     distclean = [];
     distclean_test =
       [
          ("main",
     ...
     package =
       {
          ...
          copyrights =
            [
               "(C) 2013 Compiler Technology and Computer Architecture Group\n(University of Hertfordshire) <ctca@ctca.eu>"
            ];
          maintainers = ["Pavel Zaichenkov <zaichenkov@gmail.com>"];
          authors = ["Pavel Zaichenkov <zaichenkov@gmail.com>"];
          homepage = Some "https://github.com/zayac/cal-solver";
          synopsis = "AstraKahn Term Algebra constraint aggregation layer";
          description =
            Some
              "Constraint Aggregation Layer for AstraKahn language provides a constraint\nresolution mechanism for term algebra.";
          categories = [];
          ...
          clean_custom =
            {
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("tests/*.my", ["tests/*.myerr"; "solver.log"])))
                 ]
            };
          distclean_custom =
            {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_byteopt = [(OASISExpr.EBool true, ["-w"; "A-4"])];
                      bs_nativeopt = [(OASISExpr.EBool true, ["-w"; "A-4"])]
                   },
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/cal";
                      doc_title = "API reference for CAL";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/zayac/cal-solver.git";
                      src_repo_browser =
                        Some "https://github.com/zayac/cal-solver";
                      src_repo_module = None;
                      src_repo_branch = None;
                      src_repo_tag = Some "release-$(pkg-version)";
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\130\011¦\012.àxAâ\018-Êö\129û\024";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
